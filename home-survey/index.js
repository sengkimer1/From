...
// function submitform(evevt) {
//     evevt.preventDefault();
//     let fullname = document.getElementById("fullname").value;
//     let email = document.getElementById("email").value;
//     let grade = document.querySelector('input[name="gradeLevel"]:checked').value;
//     let place = document.querySelector('input[name="learningPlace"]:checked').value;
//     let interested = document.querySelector('input[name="interestLevel"]:checked').value;
//     let previous = document.querySelector('input[name="previousExperience"]:checked').value;
//     let describe = document.getElementById("experience").value;
//     let skill = [];
//     let checkboxes = document.querySelectorAll('input[name="skill"]:checked');
//     for (let i = 0; i < checkboxes.length; i++) {
//         skill.push(checkboxes[i].value);
//     }
//     let familiar = document.querySelector('input[name="activePedagogy"]:checked').value;
//     let understanding = document.getElementById("text").value;
//     let participated = document.getElementById("text1").value;
//     let learning = document.querySelector('input[name="flexRadioDefault"]:checked').value;
//     let describe1= document.getElementById("text2").value;
//     let skill1 = [];
...
//     }
//     let type = document.querySelector('input[name="learningEnvironment"]:checked').value;
//     let important = document.querySelector('input[name="peerInteraction"]:checked').value;
//     let feel = document.querySelector('input[name="feedbackSupport"]:checked').value;
//     let skill2 = [];
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function submitForm(event) {
        ...
        let learningPlace = document.querySelector('input[name="learningPlace"]:checked');
        let interestLevel = document.querySelector('input[name="interestLevel"]:checked');
        let previousExperience = document.querySelector('input[name="previousExperience"]:checked');
        ...
        let activePedagogy = document.querySelector('input[name="activePedagogy"]:checked');
        let text = document.getElementById("text");
        let text1 = document.getElementById("text1");
        let flexRadioDefault = document.querySelector('input[name="flexRadioDefault"]:checked');
        ...
        let learningEnvironment = document.querySelector('input[name="learningEnvironment"]:checked');
        let peerInteraction = document.querySelector('input[name="peerInteraction"]:checked');
        let feedbackSupport = document.querySelector('input[name="feedbackSupport"]:checked');
        let skill2 = [];
        let checkboxes2 = document.querySelectorAll('input[name="skill2"]:checked');
        for (let i = 0; i < checkboxes2.length; i++) {
            skill2.push(checkboxes2[i].value);
...
function saveFormAnswer(datasurvey) {
